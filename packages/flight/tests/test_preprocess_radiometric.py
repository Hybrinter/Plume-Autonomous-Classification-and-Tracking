"""Unit tests for flight.payload.preprocess radiometric calibration -- apply_calibration().
...
# module under test
from flight.payload.preprocess import RadiometricCalibration, apply_calibration
