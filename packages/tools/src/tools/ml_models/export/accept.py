...
def load_manifest(path: str) -> Manifest:
    ...
    return Manifest(
        ...
        ingest_path=_optional_str(data.get("ingest_path", "")),
        radiometry=_optional_str(data.get("radiometry", "")),
    )
...
def accept_kind(
    ...
    *,
    ...
    Args:
        ...
        flight: When true, expected shapes come from ``InferenceConfig``.
            When false, ``expected_input``, ``height``, and ``width`` are used.
