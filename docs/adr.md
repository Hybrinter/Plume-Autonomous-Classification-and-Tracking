...
| ADR-REPO-0014 | [0014-driver-and-environment-selection.md](adr/0014-driver-and-environment-selection.md) | DriverConfig for HAL axes; environment reserved for simulated world | Proposed |
