...
from tools.ml_models.analysis.native import score_on_native_grid
...
from tools.ml_models.analysis.results import write_filled_tables
from tools.ml_models.analysis.scores import score_classifier, score_segmentor
from tools.ml_models.arch.study import DilateNet, ShuffleNetClassifier
...
from tools.ml_models.data.grid import rasterize_mask
from tools.ml_models.data.matrix import Cell, gsd_cells, native_cells
from tools.ml_models.data.moments import BandStats, MomentAccumulator
...
from tools.ml_models.train.study import EpochLoss, TrainConfig, run_training
from tools.ml_models.train.tiles import StudyDataset
...
def _metrics(
    ...
    if target == "label":
        ...
        from tools.ml_models.analysis.scores import _ranking_areas
