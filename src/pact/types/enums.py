"""PACT enumeration types and Result generic.

Defines all enumerations used as discriminants and state values across the PACT system,
plus the Result[T, E] / Ok[T] / Err[E] types that mirror Rust's Result<T, E>.

Satisfies: REQ-AIML-COMP-001, REQ-AIML-COMP-002 (type-safety foundation for all subsystems).

No other pact submodule is imported here. This module is the dependency root.
"""
...
Result = Union[Ok[T], Err[E]]  # type: ignore[misc]
