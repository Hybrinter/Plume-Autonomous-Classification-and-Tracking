...
| ADR-FLIGHT-0004 | [0004-elevation-relative-smear-height-proxy.md](adr/0004-elevation-relative-smear-height-proxy.md) | Elevation-relative smear cap and 2 km CoG height proxy | Accepted |
