...
def test_offsets_map_through_ifov_with_image_sign_convention() -> None:
    """+x offset -> +az; image-up offset -> negative elevation; scaled by IFOV."""
    az, el = boresight_error_deg(
...
def test_displacement_is_vertical_full_frame_pixels() -> None:
    """Deadband displacement ignores horizontal error without an azimuth actuator."""
