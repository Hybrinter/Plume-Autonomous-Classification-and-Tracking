...
def test_calibration_batches_random() -> None:
    ...
    from tools.ml_models.export.onnx import _calibration_batches
...
def test_copy_matching_initializers_rejects_shape_mismatch(tmp_path: Path) -> None:
    ...
    from tools.ml_models.export.onnx import _copy_matching_initializers
...
def test_export_segmentor_then_accept(tmp_path: Path) -> None:
    ...
    if importlib.util.find_spec("onnxruntime") is not None:
        from tools.ml_models.export.accept import onnx_inference_fn
...
def test_promote_rejects_failed_gate(tmp_path: Path) -> None:
    ...
    from tools.ml_models.export.accept import AcceptanceReport
