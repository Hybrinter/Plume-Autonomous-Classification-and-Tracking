...
import pytest
from tools.ml_models.train.sweep import load_sweep_space, sweep
...
def test_known_registry_and_unknown_arch_space(tmp_path: Path) -> None:
    """The registry lists pairs. An unknown architecture in a space raises."""
