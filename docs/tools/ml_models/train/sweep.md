# tools.ml_models.train.sweep

**Source:** `packages/tools/src/tools/ml_models/train/sweep.py`
**Kind:** module
...
4. Overlay each trial onto `TrainConfig` and reject an unknown architecture.
